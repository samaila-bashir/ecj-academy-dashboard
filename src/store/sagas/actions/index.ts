export enum SAGA_ACTIONS {
  ...
  LINK_USER = "LINK_USER",
  ADD_PLAYER_SALARY = "ADD_PLAYER_SALARY",
  GET_PLAYER_SALARIES = "GET_PLAYER_SALARIES",
  EDIT_PLAYER_SALARY = "EDIT_PLAYER_SALARY",
  DELETE_PLAYER_SALARY = "DELETE_PLAYER_SALARY",
}
